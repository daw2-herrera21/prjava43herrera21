...
public class Prjava43herrera21 extends Frame implements ActionListener, WindowListener {
...
public Prjava43herrera21 () {
    ...
    setTitle("prjava43cognom21"); // "this" Frame sets title
    setSize(250, 100); // "this" Frame sets initial size
    setVisible(true); // "this" Frame shows
}
/** The entry main() method */
public static void main(String[] args) {
    new Prjava43herrera21(); // Let the construct do the job
}
/** ActionEvent handler */
@Override
